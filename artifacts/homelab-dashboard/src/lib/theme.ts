...
export const THEMES: ThemeMeta[] = [
  ...
  },
  {
    id: "nebula",
    name: "Slate",
    description: "Neumorphic dark — soft charcoal, extruded, big radius",
    dark: true,
    radius: "1rem",
    font: "'Inter', ui-sans-serif, system-ui, sans-serif",
    swatch: { background: "#1c1f2e", surface: "#1c1f2e", primary: "#818cf8", accent: "#818cf8" },
    defaults: { primary: "#818cf8", background: "#1c1f2e" },
    template: {
      shadow: "soft",
