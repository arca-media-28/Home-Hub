...
const SUPPORTED_SERVICES = ["truenas", "plex", "jellyfin", "subsonic", "sonarr", "radarr", "lidarr", "qbittorrent", "pihole", "nginx-proxy-manager", "prowlarr", "pterodactyl", "tailscale", "ersatztv", "stocks"];
