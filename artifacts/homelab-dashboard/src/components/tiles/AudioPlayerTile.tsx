...
function fmtTime(value: number, unit: "ms" | "s"): string {
...
function Artwork({ track, size }: { track: AudioTrack | null; size: number }) {
...
export default function AudioPlayerTile({ enabled, density, tileSettings }: WidgetProps) {
