...
export default function RadarrTile({ enabled, density }: WidgetProps) {
  const { data, isLoading, isError } = useGetRadarrQueue({
    query: { queryKey: getGetRadarrQueueQueryKey(), refetchInterval: 30_000 },
  });
