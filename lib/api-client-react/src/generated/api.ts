...
export const getGetPterodactylWidgetUrl = () => {




  return `/api/widgets/pterodactyl`
}

/**
 * @summary Get game server list with per-server state and live resource usage from the Pterodactyl panel
 */
export const getPterodactylWidget = async ( options?: RequestInit): Promise<PterodactylData> => {

  return customFetch<PterodactylData>(getGetPterodactylWidgetUrl(),
  {
    ...options,
    method: 'GET'
...
export const getGetPterodactylWidgetQueryKey = () => {
    return [
    `/api/widgets/pterodactyl`
    ] as const;
    }


export const getGetPterodactylWidgetQueryOptions = <TData = Awaited<ReturnType<typeof getPterodactylWidget>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getPterodactylWidget>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetPterodactylWidgetQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getPterodactylWidget>>> = ({ signal }) => getPterodactylWidget({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getPterodactylWidget>>, TError, TData> & { queryKey: QueryKey }
}

export type GetPterodactylWidgetQueryResult = NonNullable<Awaited<ReturnType<typeof getPterodactylWidget>>>
export type GetPterodactylWidgetQueryError = ErrorType<unknown>
...
export function useGetPterodactylWidget<TData = Awaited<ReturnType<typeof getPterodactylWidget>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getPterodactylWidget>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetPterodactylWidgetQueryOptions(options)
