...
vi.mock("@workspace/api-client-react", () => ({
  ...
  useGetPhotosWidget: () => ({ data: undefined, isError: false }),
  useGetDeviceModes: () => ({ data: [{ id: 1, name: "PC", variant: null }] }),
  useCreateDeviceMode: () => ({ mutate: vi.fn(), isPending: false, isError: false }),
  useUpdateDeviceMode: () => ({ mutate: vi.fn(), isPending: false, isError: false }),
  useDeleteDeviceMode: () => ({ mutate: vi.fn(), isPending: false, isError: false }),
  useGetPageLayouts: () => ({ data: [] }),
  useCopyPageLayout: () => ({ mutate: vi.fn(), isPending: false, isError: false }),
  getGetDeviceModesQueryKey: () => ["/api/device-modes"],
  getGetPageLayoutsQueryKey: (pageId: number) => ["/api/pages", pageId, "layouts"],
  getGetPhotosWidgetQueryKey: () => ["/api/widgets/photos"],
